...
Mobile driver/operator application for managing assigned orders, navigation workflows, issue reporting, vehicle context, and driver-facing operational flows.

## Allowed Work

- Bug fixes and small enhancements for assigned orders, navigation, driver workflows, issue reporting, and vehicle context.
- React Native UI, test, documentation, and platform compatibility fixes that preserve app conventions.
- Mobile workflow changes when documentation and API impact are evaluated.

## Restricted Work

- Native signing, bundle identifiers, production app credentials, certificates, or release profiles without explicit approval.
- Navigation, location tracking, or driver workflow rewrites without review.
