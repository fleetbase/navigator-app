...
export const OrderCard = ({ order, onClick, onTrackerDataLoaded, delayFetch = 100 }) => {
        ...
        <Pressable onPress={handlePress}>
            <YStack bg='$background' borderRadius='$4' borderWidth={1} borderColor='$borderColor' gap='$3'>
                ...
                <YStack px='$3' pb='$1' gap='$3'>
                    <YStack>
                        <LiveOrderRoute order={order} zoom={3} height={150} YEdgePadding={60} XEdgePadding={40} width='100%' borderRadius='$4' />
                    </YStack>
                    <YStack>
